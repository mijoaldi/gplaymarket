    ...
    navbar-light bg-light p-3" id="menu">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex">
                    ...
                    <button class="btn btn-outline-dark btn-primary-outline-success" type="button"><img src="./Recursos/imagenes/buscar.png" alt=""></button>
                </form>
            </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="./registro_iniciar.php"><img length="50px" width="50px" src="./Recursos/imagenes/usur.png"></a>
                </li>
                <li class="nav-item">
